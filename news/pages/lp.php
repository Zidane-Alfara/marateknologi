              ...
              ?>
                ...
                <div>
                  ...
                  <p class="fs-13 text-muted mb-0">
                    <span class="mr-2"><i class="mdi mdi-account">&nbsp; <?= $contentById['author']; ?></i></span><i
                      class="mdi mdi-calendar">&nbsp; <?= substr($contentById['tanggal'], 0,10); ?></i>
                  </p>
                  ...
                  <p class="mb-2 fs-15">
                    <?= html_entity_decode($contentById['content']); ?>
                  </p>
                </div>
                ...
                <div class="d-lg-flex mt-5">
                  ...
                  <div class="d-lg-flex justify-content-end">
                    <div>
                      <ul class="social-media mb-3" style="float: right;">
                        <li>
                          <a href="#">
